  ...
  return (
    <div className="min-h-screen bg-white text-neutral-800 font-sans selection:bg-[#ff4d00] selection:text-white antialiased">
      ...
      <InteractiveBentoGallery
        id="fd3-evidencia"
        title="FD3 en la vida real"
        subtitle="Pruebas de Campo Reales"
        description="Explora por qué el Fisherman FD3 es la revolución de la pesca tecnológica. No te lo contamos, te lo mostramos en cada detalle."
        mediaItems={fd3GalleryItems}
        whatsappMessagePrefix="Hola SwellPro Perú, he estado revisando su galería de evidencias reales en uso con el Fisherman FD3. Deseo recibir más información y coordinar detalles sobre este equipo."
      />
      ...
      <footer className="py-20 text-center bg-neutral-950 text-white relative">
        <div className="max-w-2xl mx-auto px-6">
          ...
          <div className="mt-12 text-neutral-600 font-sans-dm text-[11px] border-t border-neutral-900 pt-8">
