      ...
      <footer className="bg-neutral-950 text-white py-16 font-sans-dm">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-center gap-4 mt-8 pb-4">
            <span className="text-neutral-400 font-display font-bold text-xs uppercase tracking-widest hidden sm:inline">Síguenos en:</span>
            <div className="flex items-center gap-3">
              <a 
                href="https://www.facebook.com/share/195TLy8GEY" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="bg-neutral-900 border border-neutral-800 p-2.5 rounded-full hover:bg-[#ff4d00] hover:text-white transition-all duration-200 text-neutral-400 flex items-center justify-center hover:scale-105" 
