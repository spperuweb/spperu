  ...
  return (
    <div className="min-h-screen bg-white text-neutral-800 font-sans selection:bg-[#ff4d00] selection:text-white antialiased">
      ...
      <InteractiveBentoGallery
        id="fd1s-evidencia"
        title="FD1S en la vida real"
        subtitle="Pruebas de Campo Reales"
        description="Explora todo el material de campo real recopilado por pescadores en alta mar. Evidencia 100% real de la resistencia y capacidad de SwellPro."
        mediaItems={fd1sGalleryItems}
        whatsappMessagePrefix="Hola SwellPro Perú, he estado revisando su galería de evidencias reales en uso con el Fisherman FD1S. Deseo recibir más información y coordinar detalles sobre este equipo."
      />
      ...
      <footer className="py-16 text-center bg-neutral-950 text-white border-t border-neutral-900">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-neutral-500 font-sans text-[11px] leading-tight">
